...
const exchange_name = 'LoliExchange';             // TODO: fill in the name of your exchange

const token_name = 'LoliPop';                // TODO: replace with name of your token
const token_symbol = 'LOL';              // TODO: replace with symbol for your token
...
async function init() {
    ...
    console.log(`User ${defaultAccount} balances:`);
    console.log(`ETH: ${ethers.utils.formatEther(ethBalance)} ether`);
    console.log(`Tokens: ${tokenBalance.toString()} tokens`);
